...
test('README screenshots', async () => {
  ...
  // the ring view, and the same page once the window is too narrow for a table
  await page.getByTestId('view-toggle').click()
  await page.waitForTimeout(700)
  await shot(page, 'doc-accounts-rings')
  await page.getByTestId('view-toggle').click()
  ...
  await page.waitForTimeout(500)
  await shot(page, 'doc-accounts-compact')

  await page.setViewportSize({ width: 1240, height: 780 })
  await page.getByTestId('nav-mappings').click()
  await page.waitForTimeout(400)
  await shot(page, 'doc-mappings')
  await app.close()
})
